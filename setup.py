'''
Developer: Jason Liu following code from Atith Gandhi
Usage: Execute setup.py
'''
...
hs = ['HS', 'hard_high_school', 'easy_high_school', 'regular_high_school', 'national_high_school']

# Download qanta.json
dirname = os.path.dirname(__file__)
filename = os.path.join(dirname, 'data/qanta.json')
if not os.path.isfile(filename):
    print('Downloading data into data/qanta.json...')
    res = requests.get('https://s3-us-west-2.amazonaws.com/pinafore-us-west-2/qanta-jmlr-datasets/qanta.train.2018.04.18.json')
